...
HOOKDEF(BOOL, WINAPI, CryptHashData,
	...
	LOQ_bool("crypto", "pci", "CryptHash", hHash, "Buffer", dwDataLen, pbData, "Length", dwDataLen);
	return ret;
}
...
HOOKDEF(NTSTATUS, WINAPI, BCryptExportKey,
	...
	LOQ_ntstatus("crypto", "ppiih", "hKey", hKey, "hExportKey", hExportKey, "cbOutput", cbOutput, "BlobType", pszBlobType, "Flags", dwFlags); // Modify category, LOQ_ function and log message according to your needs
	return ret;
}
