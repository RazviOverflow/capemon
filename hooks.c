...
//	HOOK(user32, EnumWindows),	// Disable for now, invokes a user-specified callback that can contain
	...
	HOOK(kernelbase, PathRenameExtensionA),
	HOOK(kernelbase, PathRenameExtensionW),
	HOOK(kernelbase, PathCombineA),
	HOOK(kernelbase, PathCombineW),
	// HOOK(pathcch, PathCchCombine), // Internally calls to PathCchCombineEx
	HOOK(kernelbase, PathCchCombineEx),
	HOOK(kernelbase, PathAllocCombine),
	HOOK(kernelbase, PathAddExtensionA),
	HOOK(kernelbase, PathAddExtensionW),
